...
function App() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-paleBlue bg-mobile bg-contain bg-no-repeat font-redHat sm:bg-desktop sm:bg-auto sm:bg-top">
      <div className="mx-5 space-y-9 overflow-hidden rounded-3xl bg-white">
